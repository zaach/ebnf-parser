...
case 129:
    ...
    // TODO ...
    yyparser.yyError("module code declaration error?");
    break;
  ...
  var lexer = {
    ...
    */
    ...
    rules: [
      ...
      /* 25: */  /^(?:([^\S\n\r])+)/,
      /* 26: */  /^(?:(\r\n|\n|\r)+)/,
      /* 27: */  new XRegExp('^(?:\\[([\\p{Alphabetic}_](?:[\\p{Alphabetic}\\p{Number}_])*)\\])', ''),
      ...
      /* 55: */  new XRegExp('^(?:<([\\p{Alphabetic}_](?:[\\p{Alphabetic}\\p{Number}_])*)>)', ''),
      /* 56: */  new XRegExp('^(?:\\{\\{[^]*?\\}\\})', ''),
      /* 57: */  new XRegExp('^(?:%\\{[^]*?%\\})', ''),
      /* 58: */  /^(?:\{)/,
      /* 59: */  /^(?:->.*)/,
