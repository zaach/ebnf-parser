/* parser generated by jison 0.4.15-109 */
/*
...
var $V0=[5,11,14,16,18,23,24,29,35,37,40,41,42],
    $V1=[11,27],
    $V2=[5,11,14,16,18,23,24,27,29,35,37,40,41,42,47],
    $V3=[5,11,14,16,18,23,24,27,28,29,35,37,40,41,42],
    $V4=[5,11,14,16,18,23,24,27,28,29,35,37,40,41,42,59,73,77,123],
    $V5=[5,8,11,14,16,18,23,24,27,29,35,37,40,41,42,59,77,80],
    $V6=[8,77],
    $V7=[5,8],
    $V8=[5,11,14,16,18,23,24,27,28,29,35,37,40,41,42,47],
    $V9=[11,27,28,59,66,71,73,77,123],
    $Va=[11,59,73,77,123],
    $Vb=[11,27,28,59,66,67,71,73,77,123],
    $Vc=[11,27,28,59,65,66,67,71,73,77,123],
    $Vd=[11,27,28,59,65,66,67,68,69,70,71,73,77,123],
    $Ve=[27,28,66,67],
    $Vf=[75,123];
...
symbols_: {
  ...
  "error": 2,
  "expression": 63,
  "expression_suffix": 60,
  "extra_parser_module_code": 9,
  "full_token_definition": 43,
  ...
  "optional_token_description": 46,
  "optional_token_type": 44,
  "optional_token_value": 45,
  "options": 22,
  "parse_param": 20,
  "parser_type": 21,
  "prec": 56,
...
table: [
  ...
  __expand__([5,11,14,16,18,23,24,27,28,29,35,37,40,41,42,47,48,58,59,73,77,123], [
      2,
      75
    ], {124:[
      2,
...
/* generated by jison-lex 0.3.4-109 */
var lexer = (function () {
// http://stackoverflow.com/questions/1382107/whats-a-good-way-to-extend-error-in-javascript
// http://stackoverflow.com/questions/1382107/whats-a-good-way-to-extend-error-in-javascript
...
/*! Conditions:: options */ 
/*! Rule::       "(\\\\|\\"|[^"])*" */ 
 yy_.yytext = yy_.yytext.substr(1, yy_.yytext.length - 2); return 34; 
break;
case 12 : 
/*! Conditions:: options */ 
/*! Rule::       '(\\\\|\\'|[^'])*' */ 
...
/*! Conditions:: bnf ebnf token INITIAL */ 
/*! Rule::       {HEX_NUMBER} */ 
 yy_.yytext = parseInt(yy_.yytext, 16); return 48; 
break;
case 50 : 
/*! Conditions:: bnf ebnf token INITIAL */ 
/*! Rule::       {DECIMAL_NUMBER}(?![xX0-9a-fA-F]) */ 
 yy_.yytext = parseInt(yy_.yytext, 10); return 48; 
break;
case 51 : 
/*! Conditions:: bnf ebnf token INITIAL */ 
/*! Rule::       . */ 
