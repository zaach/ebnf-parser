...
symbols_: {
  ...
  "error": 2,
  "expression": 75,
  "extra_parser_module_code": 84,
  "full_token_definitions": 61,
  "grammar": 67,
  "handle": 72,
  "handle_action": 71,
  "handle_list": 70,
  ...
  "import_name": 51,
  "import_path": 52,
  "include_macro_code": 85,
  "module_code_chunk": 86,
  "one_full_token": 62,
  "operator": 58,
  "option": 55,
  "option_list": 54,
  ...
  "optional_module_code_chunk": 87,
  "optional_token_type": 63,
  "options": 53,
  "parse_params": 56,
  "parser_type": 57,
  "prec": 77,
  ...
  "spec": 46,
  "suffix": 76,
  "suffixed_expression": 74,
  "symbol": 78,
  "token_description": 65,
  "token_list": 60,
  "token_value": 64,
  "{": 12,
  "|": 6,
...
/*! Rule::       %{NAME}([^\r\n]*) */ 
                                            ...
                                            this.warn('EBNF: ignoring unsupported parser option:', dquote(yy_.yytext), 'while lexing in', this.topState(), 'state:\n' + indent(this.showPosition(l1, l2), 4)
                                                // , '\n', {
...
/*! Conditions:: bnf ebnf token INITIAL */ 
/*! Rule::       ->.* */ 
 yy_.yytext = yy_.yytext.substr(2, yy_.yyleng - 2).trim(); return 41; 
break;
case 59 : 
/*! Conditions:: bnf ebnf token INITIAL */ 
/*! Rule::       →.* */ 
 yy_.yytext = yy_.yytext.substr(1, yy_.yyleng - 1).trim(); return 41; 
break;
case 60 : 
/*! Conditions:: bnf ebnf token INITIAL */ 
/*! Rule::       {HEX_NUMBER} */ 
...
/*! Conditions:: path */ 
/*! Rule::       "{DOUBLEQUOTED_STRING_CONTENT}" */ 
 yy_.yytext = this.matches[1]; this.popState(); return 44; 
break;
case 75 : 
/*! Conditions:: path */ 
/*! Rule::       '{QUOTED_STRING_CONTENT}' */ 
